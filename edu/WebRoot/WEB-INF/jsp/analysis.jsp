...
<body>
				...
				<div id="page-content">
					<div class="panel">
						...
						<div class="panel-body">
							<div class="row">
								<form name="table_head" class="form-inline" id="analysisForm">
				                    <div class="col-xs-12" name="search_item">
				                        ...
				                        <button type="reset" id="export" class="btn btn-info">导出</button>
				                    </div>
				                </form>
							</div>
							<div class="row">
	...
	<script type="text/javascript" src="<%=basePath%>/resources/js/analysis.js"></script>
</body>
</html>
