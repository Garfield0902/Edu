...
public class ReflectionUtils {
	...
	/**
	 * 拿到 target对象的 propertyName 属性的类型
	 * @author zhangwc
	 * @Description: TODO
	 * @param @param target
	 ...
	 * @date 2017-7-27
	 */
	public static Class getFieldClazz(Object target,String propertyName){
		Class clazz= null;
		try {
			clazz = target.getClass().getDeclaredField(propertyName).getType();
